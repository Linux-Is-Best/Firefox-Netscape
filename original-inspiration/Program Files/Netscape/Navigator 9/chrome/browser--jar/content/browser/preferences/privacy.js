/*
//@line 40 "/cygdrive/c/builds/rklein/trunk/mozilla/browser/components/preferences/privacy.js"
*/
...
var gPrivacyPane = {
  ...
  readDenyExternalCookies: function ()
  {
    var pref = document.getElementById("network.cookie.cookieBehavior");
    var denyExternalCookies = (pref.value == 1);
    return denyExternalCookies;
  },
   ...
   * "accept cookies" checkbox being checked or unchecked.
   */
  writeDenyExternalCookies : function ()
  {
    var checkbox = document.getElementById("acceptCookies");
	  var checkbox2 = document.getElementById("denyExternalCookies");
