//@line 40 "/cygdrive/c/builds/rklein/trunk/mozilla/browser/components/preferences/content.js"
...
var gContentPane = {
  ...
  { 
		if (document.getElementById("loadImages").checked) {
			if (document.getElementById("denyExternalImages").checked)
				return 3;
  ...
  /**
   * Converts the value of the permissions.default.image preference into a
   * Boolean value for use in determining the state of the "for originating
   * website only" checkbox, returning true if images should only be loaded
   * for the originating website and false otherwise.
   */
  readDenyExternalImages: function ()
  {
    var pref = document.getElementById("permissions.default.image");
    return (pref.value == 3);
  },
